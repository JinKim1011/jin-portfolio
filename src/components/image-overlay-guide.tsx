const keyboardGuideWrapper =
  "hidden md:block absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 justify-center gap-3 whitespace-nowrap text-label-small text-content-default bg-surface/50 p-2 backdrop-blur-[1px]";
