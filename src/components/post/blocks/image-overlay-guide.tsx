const keyboardGuideWrapper =
  "hidden md:flex absolute bottom-4 left-1/2 z-10 -translate-x-1/2 justify-center gap-3 whitespace-nowrap text-label-small text-content-default bg-transparent p-2";
